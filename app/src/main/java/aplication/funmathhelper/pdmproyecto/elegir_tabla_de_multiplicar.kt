...
import aplication.funmathhelper.pdmproyecto.tablasmultiplicar.TablasChoice
...
class elegir_tabla_de_multiplicar : Fragment() {
    ...
    override fun onCreateView(
        ...
        var binding = DataBindingUtil.inflate<FragmentElegirTablaDeMultiplicarBinding>(inflater,
            R.layout.fragment_elegir_tabla_de_multiplicar, container,false)
