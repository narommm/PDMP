 ...
 */
class resta_explicacion_uno : Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        var binding = DataBindingUtil.inflate<FragmentRestaExplicacionUnoBinding>(inflater,
            R.layout.fragment_resta_explicacion_uno, container,false)
